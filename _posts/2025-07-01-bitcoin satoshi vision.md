---
tags: internet
title: Bitcoin Satoshi Vision
---

You've heard of Bitcoin and it's legendary Satoshi Nakamoto. You might have heard of Bitcoin Cash, the hard fork that's actually usable as cash instead of just a store of value.

Enter Bitcoin Satoshi Vision, the one fork to end them all, free of the corruption of Bitcoin and Bitcoin Cash, from the hands of Satoshi Nakamoto, the god himself, revealed to us in the form of an [unknown australian genius][1], as Wired called him. There are haters, of course, not everyone believed Jesus was the messiah, so [please ignore that Binance delisted BSV and the CEO called our Satoshi a fraud](https://www.coindesk.com/markets/2019/04/15/binance-delists-bitcoin-sv-ceo-calls-craig-wright-a-fraud). Quote, "The real Satoshi can digitally sign any message to prove it. This is as simple as breathing for him/her. And we have the pub key.", end quote.

Guess what, hater? He actually [did it](https://archive.ph/20160502072026/http://www.drcraigwright.net/jean-paul-sartre-signing-significance/). Yeah you litte shi- oh wait nvm the signature is just from a random Satoshi transaction. The base64 at the top of the post? it's... just a message that says "Wright, it is not the same as if I sign Craig Wright, Satoshi.", not a signature or anything. Okay. Ah. HA HA funny tricks Satoshi. You' are so funny.
