...
{% include youtube.html id="lUbiCZLzuaU" %}
...
{% include youtube.html id="jrGOylZ63oE" %}
...
{% include youtube.html id="btp7Jfo-Sqw" %}
...
When you see the [their "references" playlist](https://x.com/kbsnk_templime/status/1911422400542973996) you get a glimpse of the chaos that led to the creation of more chaos (this song). Can you imagine making music in a headspace you get from listening to a playlist like that.

## Soushi Sakiyama - Diary
{% include youtube.html id="QMECWjpDPB4" %}
...
## Synthion - 雪割草
{% include youtube.html id="UefczmPSEB4" %}
